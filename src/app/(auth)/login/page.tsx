    ...
    <div className="min-h-svh flex flex-col justify-center p-6 bg-background">
      ...
      <Card className="border-none shadow-xl bg-card rounded-[2rem]">
        <CardHeader className="space-y-1">
          ...
          <CardDescription>Enter your credentials to access your books.</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <Button variant="outline" className="w-full h-12 rounded-xl flex gap-2" onClick={handleGoogleLogin}>
